...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      <div class="col-3">
        <img id="profile-picture" src="img/mifoto.jpg" alt="">
      </div>
      <div class="col">
        <h1><?php echo "Antonio Quesada Cuadrado";?></h1>
        <h2><?php echo "DWES" ?></h2>
        <ul>
          <li>Mail: a19qucuan@iesgrancapitan.org</li>
          <li>Phone: 626598616</li>
          <li>LinkedIn: Incluye linkedin</li>
          <li>Twitter: @antonioq00</li>
        </ul>
      </div>
    </div>
    <div class="row">
